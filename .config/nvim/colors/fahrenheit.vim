...
if &t_Co >= 256 || has("gui_running")
    hi cmp ctermbg=232 ctermfg=231 cterm=NONE guibg=#0f0f0f guifg=#ffffff gui=NONE
    hi Normal ctermbg=16 ctermfg=231 cterm=NONE guibg=#000000 guifg=#ffffff gui=NONE
    set background=dark
    hi NonText ctermbg=bg ctermfg=236 cterm=NONE guibg=bg guifg=#303030 gui=NONE
    ...
    hi VimFunction ctermbg=bg ctermfg=231 cterm=bold guibg=bg guifg=#ffffff gui=bold
    ...
    hi CtrlPPrtText ctermbg=bg ctermfg=231 cterm=NONE guibg=bg guifg=#ffffff gui=NONE
